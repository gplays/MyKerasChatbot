...
def load_parameters():
    ...
    STRUCTURE_PATH = None                        #path to a Keras' model json file. Ifwe speficy this parameter then 'type' will be only an informative parameter.

    N_CLASSES = 2                                # Number of classes

    # Word embedding parameters
    PRETRAINED_VECTORS = '/media/HDD_2TB/DATASETS/cnn_polarity/DATA/word2vec.%s.npy' % SRC_LAN   # Path to pretrained vectors. Set to None if you don't want to use pretrained vectors.
    PRETRAINED_VECTORS_TRAINABLE = True                                                          # Finetune or not the word embedding vectors.
    ...
    #Optimizers Params
    lr = None
    momentum = None, loss = None, loss_weights = None, metrics = \
        None, epsilon = 1e-8,
    nesterov = True, decay = 0.0, clipnorm = 10., clipvalue = 0., optimizer =\
